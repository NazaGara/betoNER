...
from transformers import BertForTokenClassification, AutoModelForMaskedLM, AutoTokenizer, BertForTokenClassification, BertTokenizer, BertConfig, BertModel
class BERTClass(torch.nn.Module):
    def __init__(self, amount_tags):
        super(BERTClass, self).__init__()
        #for token classification or for masked LM? 
        self.l1 = AutoModelForMaskedLM.from_pretrained("dccuchile/bert-base-spanish-wwm-cased", num_labels=amount_tags)
